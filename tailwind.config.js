...
// ---------------------------------------------------------------------------
// Bảng màu lấy theo mẫu TailAdmin (tailadmin-free-tailwind-dashboard-template)
// - brand  : màu chủ đạo (xanh #465fff)
// - gray   : thang xám TailAdmin (thay cho slate mặc định)
// - success/error/warning: màu trạng thái
// Các họ màu cũ của app (sky, teal → brand; slate → gray; rose → error;
// amber → warning; emerald/green → success) được ánh xạ lại để toàn bộ
// giao diện hiện có tự động đổi sang phong cách TailAdmin.
// ---------------------------------------------------------------------------
const brand = {
  ...
  theme: {
    extend: {
      colors: {
        ...
        error,
        warning,
        // Ánh xạ các họ màu cũ của app sang bảng màu TailAdmin
        sky: brand,
        teal: brand,
        slate: gray,
        rose: error,
